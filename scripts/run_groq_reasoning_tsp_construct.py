...
DEFAULT_CONFIG = os.path.join(REPO_ROOT, "configs", "groq_reasoning_tsp_construct.yaml")


def main():
    parser = argparse.ArgumentParser(description="Run the Groq TSP reasoning/acting probe config.")
